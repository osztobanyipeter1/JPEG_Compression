...
def inverse_zigzag(zigzag, rows, cols):
    zigzag_order = [
        (0,0),(0,1),(1,0),(2,0),(1,1),(0,2),(0,3),(1,2),
        (2,1),(3,0),(4,0),(3,1),(2,2),(1,3),(0,4),(0,5),
        (1,4),(2,3),(3,2),(4,1),(5,0),(6,0),(5,1),(4,2),
    ...
    for index, (i, j) in enumerate(zigzag_order):
        block[i, j] = zigzag[index]
    return block

def show_images(original, compressed, original_title="Original", compressed_title="Compressed"):
